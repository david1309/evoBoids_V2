...
class Boid: 
    ...
    def __init__ (self, type, strip, maxVel):
        ...
        self.neighAgent = [] # list which stores the otherAgents that the currentAgent sees 
...
def main(argv): 
    ...
    argv = [0, 1.90e+02, 5.71e-02, 1.00e+00, 7.41e-01, 3.02e+01, 5.783e+00, 2.0, 3, 1, 80] 
    ...
    # (High G: High Mouse Attraction, Low G: Low Mouse Attraction)
    gravity = 0.3
    " Obstacle Parameters "
    resources = 30 # 10
    pastNumObs = 0
    ...
    maxVel = 8.0  # Max. delta speed that can be performed on each time step
